...
class Region:
    ...
    # special case for acasxu
    lb2: Optional[torch.Tensor] = None  # shape: (1, C, H, W) or (1, D)
    ub2: Optional[torch.Tensor] = None  # same shape as lb2

    target_label: Optional[int] = None
    center_point: Optional[torch.Tensor] = None  # shape: (1, C, H, W) or (1, D)
    ...
    def add_spec_acasxu(self, prop, device, dtype):
        self.spec = prop.output_spec(device=device, dtype=dtype)
